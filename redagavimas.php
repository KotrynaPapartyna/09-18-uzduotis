...
if(isset($_GET["submit"])) {
    if(isset($_GET["pavadinimas"]) && isset($_GET["nuoroda"])
        && isset($_GET["kategorijos_id"]) 
        
        && !empty($_GET["pavadinimas"]) && !empty($_GET["nuoroda"]) 
        && !empty($_GET["kategorijos_id"])) {
        ...
        SET `pavadinimas`='$pavadinimas', `nuoroda`='$nuoroda', 
        `turinys`='$turinys', `santrauka`='$santrauka', 
