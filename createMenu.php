...
<body>
    ...
    <?php require_once("design-parts/meniu.php"); ?>
        ...
        <?php showJumbotron("Papildykite/sukurkite Meniu", "Sukurkite savo Meniu"); ?>
            ...
            if(isset($_GET["menuType"])) {
                ...
                <?php if($menuType == 1) { ?>
                    ...
                    <?php 
                        ...
                        //$target = $_GET["target"]; kazkodel neranda target
                        $alt = $_GET["alt"];
                        ...
                        if(mysqli_query($conn, $sql)) {
                            ...
                            echo "Kažkas įvyko negerai"; // tikrinti uzklausa
                            echo "<br>";
                        }
                    }
